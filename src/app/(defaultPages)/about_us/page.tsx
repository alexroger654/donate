      ...
      <section className="py-14 lg:py-24 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative ">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-9">
            ...
            <div className="lg:pl-[40px] flex items-center">
              <div className="data w-full">
                <h2 className="font-manrope font-bold text-4xl lg:text-5xl text-primary-foreground mb-4 max-lg:text-center relative">
                  Why choose us{" "}
                </h2>
                <p className="text-md font-medium text-justify mb-3  text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                  The Galleria Foundation is dedicated to addressing some of the most important problems facing our society in order to truly make an impact. We use a comprehensive strategy to create long-lasting change, whether it be via empowering women, enhancing healthcare, educating children, safeguarding the environment, or aiding communities in their recovery from natural catastrophes.
                </p>
                <p className="text-md font-medium text-justify  mb-3 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                  We collaborate closely with nearby communities to comprehend their issues and develop solutions that have a real influence. With a proven track record, a committed staff, and total transparency, you can be sure that every donation gets to the people who need it the most.
                </p>
                <p className="text-md font-medium text-justify  text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                  WWe at Galleria Foundation are committed to working together to create a better future. Supporting us means more than just making a donation; it means changing lives and building a brighter future for everybody.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-14 lg:py-24 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative ">
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
            <div className="lg:pr-10 flex items-center">
              <div className="data w-full">
                <img
                  src="/assets/why_us.jpg"
                  alt="About Us tailwind page"
                ...
                />
                <h2 className="font-manrope font-bold text-4xl lg:text-5xl text-primary-foreground mb-6 max-lg:text-center">
                  Process
                </h2>
                <p className="font-normal text-md text-justify leading-2 text-gray-500 max-lg:text-center max-w-2xl mx-auto mb-3">
                  {`At Galleria Foundation, we treat every donation with the utmost care, ensuring it delivers the maximum impact. Once you donate, your funds are securely processed and directed to the `}
                </p>
                <p className="font-normal text-md text-justify leading-2 text-gray-500 max-lg:text-center max-w-2xl mx-auto mb-3">
                  {`cause or project you care about the most. Working in collaboration with trusted local partners and NGOs, we implement projects on the ground, making sure that resources reach the right people and programs are executed effectively.`}
                </p>
                <p className="font-normal text-md text-justify leading-2 text-gray-500 max-lg:text-center max-w-2xl mx-auto mb-3">
                  {`Our process doesn’t end there. We continuously monitor and evaluate each initiative to ensure your contribution is used efficiently and achieves its intended goals. Transparency is a cornerstone of our work, and we provide regular updates and detailed reports so you can see the real change your support creates. At Galleria Foundation, your generosity becomes a catalyst for meaningful and lasting transformation. Together, we turn hope into action.`}
                </p>
              </div>
            </div>
            <div className="img-box ">
