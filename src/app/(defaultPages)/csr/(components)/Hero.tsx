          ...
          <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8">
            <div className="mx-auto max-w-screen-xl px-2.5 flex flex-col items-center justify-center text-center h-full w-full py-6">
              <h1 className="font-bold text-primary-foreground text-4xl lg:text-7xl leading-tight  capitalize ">
                ...
                Through Meaningful CSR Partnerships.
              </h1>
              <p className="text-lg text-muted-foreground max-w-4xl mt-10">
                Ensuring Transparency in Fund Utilization: We focus on
                delivering essential relief materials directly to those in need,
                avoiding cash transactions to maintain accountability and trust
              </p>
