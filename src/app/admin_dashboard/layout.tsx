      ...
      >
            ...
            <div className="flex flex-col justify-between flex-1 mt-6">
              <nav className="-mx-3 space-y-6 ">
                ...
                <div className="space-y-3 ">
                  ...
                  {/* <Link
                    className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                    href="/admin_dashboard/monthly_payments_layouts"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                    ...
                    <span className="mx-2 text-sm font-medium">
                      Monthly Payments Layouts
                    </span>
                  </Link> */}

                  <Link
                    className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                    href="/admin_dashboard/leads"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
        ...
        <div className="flex flex-col flex-1 w-full overflow-y-auto">
          ...
          <header className=" py-4 bg-white">
            <div className="w-full flex items-center justify-between lg:pl-16 lg:pr-8">
              <p className="text-gray-600 font-bold font-mono text-md">
                Company Name
              </p>
              <img
