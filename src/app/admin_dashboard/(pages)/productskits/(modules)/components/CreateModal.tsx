...
const CreateCategory: React.FC<IProps> = ({ isOpen, setIsOpen, refetch }) => {
  ...
  async function handleCreate() {
    ...
    const result = await createData(
      {
        ...
        description,
        image_url: "",
        product_ids: selectedProduct.map((item: any) => item.value),
      },
      "product_kit",
      setLoading,
      refetch
    ...
    if (result) {
      toast.success("Product kit created");
    }
    setIsOpen(false);
  }
          ...
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            >
              <div className="inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                ...
                <div className="lg:px-8 px-3 space-y-6 mt-10 mb-8">
                  <div className="">
                  ...
                  <button
                    ...
                    className="bg-primary px-8 py-2 rounded-lg font-bold mb-8"
                  >
