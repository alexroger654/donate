          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="w-full col-span-2 relative mt-12 lg:mt-0 lg:absolute lg:-translate-y-1/2 lg:translate-x-[35%] lg:top-1/2 ">
              ...
              >
                ...
                <SwiperSlide className="max-w-[480px] p-6">
                  <div className="flex-none w-full sm:w-2/3 lg:w-full lg:flex-1 whitespace-nowrap">
                    <div className="overflow-hidden bg-white rounded shadow-xl">
                      <div className="aspect-w-4 aspect-h-3">
                        <img
                          className="object-cover w-full h-80"
                          src="https://images.pexels.com/photos/5771459/pexels-photo-5771459.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                          alt=""
                        />
                      </div>
                      <div className="p-8">
                ...
                <SwiperSlide className=" max-w-[480px] p-6">
                  <div className="flex-none w-full sm:w-2/3 lg:w-full max-w-[450px] lg:flex-1 whitespace-nowrap">
                    <div className="overflow-hidden bg-white rounded shadow-xl">
                      <div className="aspect-w-4 aspect-h-3">
                        <img
                          className="object-cover w-full h-80"
