            ...
            <div className="box flex h-full justify-center flex-col">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-5 w-full">
                <div className="box flex flex-col items-center">
                  <button className="rounded-full p-3 flex items-center justify-center mx-auto bg-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-primary/10 hover:shadow-indigo-200">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="36"
                      height="37"
                ...
                <div className="box flex flex-col items-center">
                  <button className="rounded-full p-3 flex items-center justify-center mx-auto bg-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-iprimary/50 hover:shadow-indigo-200">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="36"
                      height="37"
