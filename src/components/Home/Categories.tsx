    ...
    <>
      <section className="h-full bg-white py-20">
        ...
        <div className="mx-auto h-full lg:container">
          <div className="flex h-full flex-col items-center justify-center md:flex-col lg:flex-row">
            <Link
              href="/gift_card_search"
              className="col-span-1 flex flex-col items-center gap-6 px-10 py-10 lg:px-4 xl:px-2"
            >
              <div>
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary transition hover:bg-primary/80 focus:bg-primary/70">
                  <svg
              ...
              <div className="flex flex-col gap-2 px-2 text-center">
                ...
                <p className="text-base font-medium leading-7 text-gray-600 lg:px-8">
            ...
            <Link
              href="/campaigns"
              className="col-span-1 flex flex-col items-center gap-6 rounded-2xl bg-white px-10 py-10 shadow-[0_8px_30px_rgb(0,0,0,0.12)]"
            >
              <div>
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary transition hover:bg-primary/80 focus:bg-primary/70">
                  <svg
          ...
          {/* <div className="flex h-full mt-16 flex-col items-center justify-center md:flex-col lg:flex-row">
            <div className="col-span-1 flex flex-col items-center gap-6 px-10 py-10 lg:px-4 xl:px-2">
              <div>
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary transition hover:bg-primary/80 focus:bg-primary/70">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-span-1 flex flex-col items-center gap-6 rounded-2xl bg-white px-10 py-10 ">
              <div>
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary transition hover:bg-primary/80 focus:bg-primary/70">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
